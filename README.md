...
Emprendimiento de venta De ropa que opera por Whatsapp (estados y Chat).
El sistema permite generar cards listas para publicar con foto,SKU, talla, color, precio, logo. Además controla inventario por variantes (modelo-talla-color) pedidos,pagos, envíos y devoluciones.
...
## Logo
<img src="https://github.com/Adrianita17/EJ-RG-2/edit/main/README.md/raw/main/Logo.png" alt="Logo ComixStore" width="250">
